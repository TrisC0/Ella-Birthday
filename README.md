...
Race **one fast lap** around a long, winding pseudo-3D (Mode-7) circuit and get a big **"Happy Birthday
...
- Complete the **lap** as fast as you can — your **best time** is saved.
- Cross the finish line → 🎉 **Happy 15th Birthday Ella!** 🎉
...
Just open `index.html` in any web browser — phone or computer.

## 🌍 Host it free on GitHub Pages

1. Make sure this repo is on GitHub (public).
...
- 🏁 One long lap, live timer + saved best time, 3·2·1·GO countdown
